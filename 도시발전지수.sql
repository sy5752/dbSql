...
9000번 사번의 DEPTNO, JOB컬럼의 값을 SMITH사원의 DEPTNO, JOB컬럼으로 동일하게 변경
SELECT deptno, job
FROM emp
WHERE ename = 'SMITH';
...
WHERE절에 기술한 조건으로 SELECT를 먼저 실행하여, 변경, 학제되는 행을 눈으로 확인 해보자
